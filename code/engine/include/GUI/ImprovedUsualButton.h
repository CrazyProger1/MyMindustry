...
#ifndef MYMINDUSTRY_IMPROVEDUSUALBUTTON_H
#define MYMINDUSTRY_IMPROVEDUSUALBUTTON_H
...
namespace engine {
    typedef std::shared_ptr<sf::RectangleShape> RectangleShapePtr;

    class ImprovedUsualButton : public Entity {
    private:
        ...
        std::vector<ArcShapePtr> m_vcCornerArcs;
        std::vector<RectangleShapePtr> m_vcBorderLines;
    ...
    public:
        ...
        explicit ImprovedUsualButton(const sf::Vector2f &size,
...
//        void setImage(Image &image);
    ...
    typedef std::shared_ptr<ImprovedUsualButton> ImprovedUsualButtonPtr;
}


#endif //MYMINDUSTRY_IMPROVEDUSUALBUTTON_H
